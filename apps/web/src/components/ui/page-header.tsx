  ...
  return (
    <header className={cn('flex flex-col gap-4 border-b border-slate-200 pb-5 sm:flex-row sm:items-end sm:justify-between', className)}>
      <div className="min-w-0">
        ...
        <h1 className="mt-1.5 text-[26px] font-semibold leading-8 text-slate-950">{title}</h1>
        {description ? <p className="mt-1.5 max-w-2xl text-sm leading-5 text-slate-600">{description}</p> : null}
      </div>
