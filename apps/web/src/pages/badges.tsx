...
import { Activity, BarChart3, Phone, Target } from 'lucide-react';
      ...
      <div className="mx-auto max-w-7xl space-y-6">
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h1 className="text-2xl font-black tracking-tight text-slate-950 md:text-3xl">Activity Milestones</h1>
            <p className="mt-1 text-sm text-slate-600">Daily spikes, tracked totals, and broker activity milestones.</p>
          </div>
            ...
            <CardContent className="p-5">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="mt-1 text-xs text-slate-500">Tracked activity milestones</p>
                </div>
            ...
            <CardContent className="p-5">
              <div className="flex items-start justify-between gap-4">
                <div className="min-w-0">
                  ...
                  <p className="mt-1 text-xs text-slate-500">{next?.description || 'All tracked milestones are complete.'}</p>
                </div>
